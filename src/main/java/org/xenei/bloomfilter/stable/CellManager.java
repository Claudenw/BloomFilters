 ...
 * </p>
 * <ul>
 * <li>{@code cell} - A collection of bits that are interpreted as a
 * counter.</li>
 * <li>{@code block} - A collection of cells that are handled as a single
 * entity, usually along native number sizes. (e.g. 8 (byte), 16 (short), 32
 * (int), 64 (long))</li>
 * </ul>
 * 
 * @since 4.5
...
public interface CellManager extends CellProducer {
    ...
    /**
     * Decrement the value of the entry by the value or sets to zero if the cell
    ...
    /**
     * Are all the cells valid. If a cell count goes negative or exceeds the number
     * of bits allocated for the value the cell is said to be invalid. A manager
     * with an invalid cell is invalid. Once a manager becomes invalid it will
     * always be invalid until {@code clear()} is called.
     * 
     * @see #clear()

 ...
 *  <p>
 *  Note: This code has been modified to use ByteBuffers.
 */
public final class MurmurHash3 {
  ...
  public static final long getLongLittleEndian(ByteBuffer buf, int offset) {
  ...
  public static int murmurhash3_x86_32(ByteBuffer data, int offset, int len, int seed) {
  ...
  @SuppressWarnings("fallthrough")
  public static void murmurhash3_x64_128(ByteBuffer key, int offset, int len, int seed, LongPair out) {
    ...
    switch (len & 15) {
      case 15: k2  = (key.get(roundedEnd+14) & 0xffL) << 48;
      case 14: k2 |= (key.get(roundedEnd+13) & 0xffL) << 40;
      case 13: k2 |= (key.get(roundedEnd+12) & 0xffL) << 32;
      case 12: k2 |= (key.get(roundedEnd+11) & 0xffL) << 24;
      case 11: k2 |= (key.get(roundedEnd+10) & 0xffL) << 16;
      case 10: k2 |= (key.get(roundedEnd+ 9) & 0xffL) << 8;
      case  9: k2 |= (key.get(roundedEnd+ 8) & 0xffL);
        k2 *= c2; k2  = Long.rotateLeft(k2, 33); k2 *= c1; h2 ^= k2;
      case  8: k1  = ((long)key.get(roundedEnd+7)) << 56;
      case  7: k1 |= (key.get(roundedEnd+6) & 0xffL) << 48;
      case  6: k1 |= (key.get(roundedEnd+5) & 0xffL) << 40;
      case  5: k1 |= (key.get(roundedEnd+4) & 0xffL) << 32;
      case  4: k1 |= (key.get(roundedEnd+3) & 0xffL) << 24;
      case  3: k1 |= (key.get(roundedEnd+2) & 0xffL) << 16;
      case  2: k1 |= (key.get(roundedEnd+1) & 0xffL) << 8;
      case  1: k1 |= (key.get(roundedEnd  ) & 0xffL);
        k1 *= c1; k1  = Long.rotateLeft(k1,31); k1 *= c2; h1 ^= k1;
    }

...
public class BitMapProducerFromByteBufferBloomFilterTest extends AbstractBitMapProducerTest {
    ...
    protected BitMapProducer createProducer() {
        ...
        final ByteBufferBloomFilter bf = new ByteBufferBloomFilter(shape);
        bf.merge(hasher);
        return bf;
    }
